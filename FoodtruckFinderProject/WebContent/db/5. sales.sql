...
insert into sales_tb (sales_id,foodtruck_id,day,location,revenue) values (sales_tb_seq.nextval,'1','20000101','동작구',5000);
insert into sales_tb (sales_id,foodtruck_id,day,location,revenue) values (sales_tb_seq.nextval,'1','20160526','강서구',6000);
insert into sales_tb (sales_id,foodtruck_id,day,location,revenue) values (sales_tb_seq.nextval,'1','20160602','강동구',3000);
